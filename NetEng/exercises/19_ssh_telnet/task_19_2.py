...
Функция подключается по SSH (с помощью netmiko) к устройству и выполняет перечень команд в конфигурационном режиме на
основании переданных аргументов.
...
if __name__ == '__main__':
    ...
    com_list = ['logging 10.255.255.1', 'logging buffered 20010', 'no logging console']

    with open("devices.yaml") as f:
        devices = yaml.safe_load(f)
    for dev in devices:
        result = send_config_commands(dev, com_list)
        print(result)
