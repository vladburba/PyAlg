...
london_co_dev = london_co[dev]
# print(london_co_dev)
london_co_dev_list = list(london_co_dev.keys())

my_string = 'Введите имя параметра (' + ', '.join(london_co_dev_list) + '): '

param = input(my_string).lower()

print(london_co_dev.get(param, 'Такого параметра нет'))
